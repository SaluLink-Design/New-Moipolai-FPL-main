...
const TeamAnalysis = () => {
    ...
    const handleAnalyze = async () => {
        ...
        try {
            ...
            setError(err.response?.data?.detail || 'Failed to analyze team. Please try again.')
        } finally {
            setLoading(false)
        }
    }
    ...
    const handleDemoAnalysis = async () => {
        ...
        try {
            ...
            setError(err.response?.data?.error || err.message || 'Failed to analyze team. Please try again.')
        } finally {
            setLoading(false)
        }
    }
